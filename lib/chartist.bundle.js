...
/***/ (function(module, exports, __webpack_require__) {
    ...
    (function (root, factory) {
      ...
      (function (window, document, Chartist) {
         ...
         * @param eventEmitter
         */
        Chartist.createLabel = function (position, length, index, labels, axis, axisOffset, labelOffset, group, classes, useForeignObject, eventEmitter, rase) {
          var labelElement;
          var positionalData = {};
          ...
          if (rase) positionalData.width = 35;
      ...
      (function (window, document, Chartist) {
        ...
        function createGridAndLabels(gridGroup, labelGroup, useForeignObject, chartOptions, eventEmitter, name) {
          ...
          projectedValues.forEach(function (projectedValue, index) {
            ...
            if (!chartOptions.showZLabels && Number.isInteger(labelValues[index])) {
            ...
            if (axisOptions.showLabel) {
              var rase = labelValues[index] < -9999 || labelValues[index] > 99999;
              if (name == "MaxHeight Generation") {
                //console.log(labelOffset.y);
                labelOffset.y += 7;
              } else if (name == "Month Generation") {
                labelOffset.y += 10;
              }
              Chartist.createLabel(projectedValue, labelLength, index, labelValues, this, axisOptions.offset, labelOffset, labelGroup, [chartOptions.classNames.label, chartOptions.classNames[this.units.dir], axisOptions.position === 'start' ? chartOptions.classNames[axisOptions.position] : chartOptions.classNames['end']], useForeignObject, eventEmitter, rase);
            }
          }.bind(this));
        }
    
        function customCreateGridAndLabels(gridGroup, labelGroup, useForeignObject, chartOptions, eventEmitter, name, rect, highLow, axisUnit) {
          var axisOptions = chartOptions['axis' + this.units.pos.toUpperCase()];
          var projectedValues = this.ticks.map(this.projectValue.bind(this));
          var labelValues = this.ticks.map(axisOptions.labelInterpolationFnc);
          var bounds = Chartist.getBounds(rect[axisUnit.rectEnd] - rect[axisUnit.rectStart], highLow, chartOptions.scaleMinSpace || 20, chartOptions.onlyInteger);
    
          projectedValues.forEach(function (projectedValue, index) {
            projectedValue = 36.25 * index;
            var labelOffset = {
              x: 0,
              y: 0
            };
            ...
            if (axisOptions.showLabel) {
              var maxY = 205;
              var percent = 1 - this.ticks[index] / bounds.max;
              percent = percent;
              var offsetY = maxY * percent;
              var fixY = 15 * percent;
              var rase = labelValues[index] < -9999 || labelValues[index] > 99999;
              labelLength = rase ? 45 : 36.25;
              if (rase) labelOffset.width = 40;
              labelOffset.y = offsetY - fixY;
              /*console.log("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
              console.log(labelValues[index]);
              ...
              console.log(labelLength);
              console.log("axisOptions.offset");
              console.log(axisOptions.offset);
              console.log("labelOffset");
              console.log(labelOffset);
              console.log("labelGroup");
              console.log(labelGroup);
              console.log("axisOptions.position");
              console.log(axisOptions.position);
              console.log("rect");
              console.log(rect);*/
        ...
        Chartist.Axis = Chartist.Class.extend({
          ...
          customCreateGridAndLabels: customCreateGridAndLabels,
      ...
      (function (window, document, Chartist) {
        ...
        function createChart(options) {
          ...
          var valueAxis, labelAxisTicks, labelAxis, axisX, axisY, axisZ;
          ...
          var seriesList = data.normalized.series[0].map(function (s) {
            return s.y;
          });
          ...
          if (options.horizontalBars) {
            ...
            if (options.axisZ === undefined) {
              options.axisZ = axisZ = new Chartist.FixedScaleAxis(Chartist.Axis.units.x, data.normalized.series, chartRect, {
                ticks: data.normalized.series[0].map(function (el) {
                  return el.y;
                }),
                highLow: highLow,
                referenceValue: 0
              ...
              axisZ = options.axisZ.type.call(Chartist, Chartist.Axis.units.x, data.normalized.series, chartRect, options.axisZ);
            }
          }
          ...
          labelAxis.createGridAndLabels(gridGroup, labelGroup, this.supportsForeignObject, options, this.eventEmitter, "Month Generation");
          valueAxis.createGridAndLabels(gridGroup, labelGroup, this.supportsForeignObject, options, this.eventEmitter, "MaxHeight Generation");
          if (options.showZLabels) axisZ.customCreateGridAndLabels(gridGroup, labelGroup, this.supportsForeignObject, options, this.eventEmitter, "Values Generation", chartRect, highLow, Chartist.Axis.units.y);
      ...
      //module.exports.Chartist = Chartist;
